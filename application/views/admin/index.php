...
<head>
  ...
  <!-- Google Font -->
  <link rel="stylesheet" href="<?= base_url(); ?>assets/admin/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
</head>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url(); ?>admin/tabel_properti"><i class="fa fa-circle-o"></i>Form Properti</a></li>
            <li><a href="<?= base_url(); ?>admin/tabel_agent"><i class="fa fa-circle-o"></i>Form Agents</a></li>
            <li><a href="<?= base_url(); ?>admin/tabel_iklan"><i class="fa fa-circle-o"></i>Form Iklan</a></li>
          </ul>
        </li>
        </ul>
    </section>
